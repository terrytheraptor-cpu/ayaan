...
import { A as isResolvedRedirect, D as resolveManifestCssLink, E as resolveManifestAssetLink, L as invariant, N as rootRouteId, O as executeRewriteInput, P as isNotFound, T as getStylesheetHref, a as replaceSsrResponse, i as normalizeSsrResponse, k as isRedirect, l as RouterProvider, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, w as getScriptPreloadAttrs } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DxRBXOKW.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DUbaggHE.mjs"),
		import("./start-D5hUvcAp.mjs"),
