...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-D7qpboqH.js
...
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
		const message = `Missing Supabase environment variable(s): ${[...!SUPABASE_URL ? ["SUPABASE_URL"] : [], ...!SUPABASE_PUBLISHABLE_KEY ? ["SUPABASE_PUBLISHABLE_KEY"] : []].join(", ")}. Set them in your environment.`;
